 ...
 * Removing consent removes script nodes and clears known first-party cookies where possible.
 */
...
/** Best-effort cookie cleanup when consent is withdrawn */
...
export function syncTrackingScripts(consent: CategoryConsent): void {
  ...
  // Analytics bucket: GA, GTM, Hotjar
  ...
  // Marketing bucket: Meta, LinkedIn (GTM may also fire ads, consent mode handles Google)
