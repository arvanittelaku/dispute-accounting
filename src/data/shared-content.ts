export const CPR_PART_35_CONTENT = `A dispute accountant instructed as an expert witness owes their primary duty to the court under CPR Part 35 — not to the instructing solicitor or their client. This applies whether appointed jointly or by one party. Independence is the foundation of credible dispute accounting expert evidence.
...
export const SJE_VS_PAE_CONTENT = `**Single Joint Expert (SJE):** Appointed under CPR 35.7 when the court directs both parties to instruct the same expert jointly. Cost is typically shared equally. The SJE produces one report for the court. Either party may ask questions of the expert under CPR 35.6. SJE appointment is common in share valuation, matrimonial business valuation, and lower-value commercial disputes where a single independent view is preferred.
...
export const FPR_PART_25_CONTENT = `Family proceedings requiring accounting expert evidence are governed by FPR Part 25, which mirrors CPR Part 35 in imposing an overriding duty to the court. Dispute accountants instructed in matrimonial financial remedy proceedings provide business valuations, hidden income analysis, and Form E review under the same principles of independence and objectivity.

Experts in family proceedings must comply with FPR PD 25A and may be directed to meet and produce a joint statement where both parties have instructed experts on the same issue.`;
