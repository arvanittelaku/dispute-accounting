...
export const metadata = createMetadata({
  title: "Cookie Policy | DisputeAccounting.com",
  description:
    "How DisputeAccounting.com uses cookies and similar technologies. Manage your preferences and learn about GDPR-compliant cookie categories.",
  path: "/cookies",
});
